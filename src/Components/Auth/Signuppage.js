...
function SignupPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Signed Up:', { role, name, email, password });
    navigate('/');
  };
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 to-purple-200">
      <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md transform transition duration-500 hover:scale-105 hover:shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold py-2 rounded shadow-md hover:shadow-lg hover:scale-105 transform transition duration-300"
          >
            Sign Up
          </button>
        </form>
        ...
        <button
          ...
          className="w-full mt-4 text-purple-500 hover:text-purple-700 hover:underline transition duration-300"
        >
